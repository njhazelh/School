...
(define testworld3 
  (new world% (send cannon1 dead-cannon) (list alien1) alien0 empty)) ;; dead cannon
...
(check-expect (remove-dead (new world% cannon1 (list alien1) alien0
  ...
  (check-expect (remove-dead (new world% 
                                  cannon1
                                  (list (new alien% 100 (- SCENE-HEIGHT CANNON-HEIGHT)
                           ALIEN-VELOCITY 'alien1 TICK-START))
                                  alien0
                                  (list bullet1))) 
                (new world% cannon1 empty alien0 empty))
  
  (check-expect (remove-dead (new world% cannon1 (list (new alien% SCENE-HALF-WIDTH 
                           (- SCENE-HEIGHT CANNON-HALF-HEIGHT)
                           ALIEN-VELOCITY 'alien1 TICK-START)) alien0 empty))
