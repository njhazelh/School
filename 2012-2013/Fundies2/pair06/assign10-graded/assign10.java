...
//> countSubs, fullUnit and hasPeon should
//> include this worker, so subs should return 1,
//> fullUnit should return an LoE with this
//> and hasPeon should check if name == this.name
//> <-4>
...
class NoEvent implements Schedule {
    ...
    //> freeTime should call its helper like in the ConsEvent class
    //> and be able to be pulled to a superclass <-2>
